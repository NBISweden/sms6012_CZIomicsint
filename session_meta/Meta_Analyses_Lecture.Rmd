...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      slideNumberFormat: "Omics-Integration CZI 2022 • %current%/%total%"
...
## Meta-analyses Co-expression networks using [MetaDCN](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6041767/)
 ...
 - The differential correlation relationship could arise from meaningful biological sources as well as uncorrected technical biases unwanted batch effect, or mixture of tissues could potentially contribute to co-expression relationships
